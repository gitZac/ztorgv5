        ...
        <div class="promo">
            ...
            <div class="row">
               ...
               <div class="col-1-of-3">
                   ...
                   <img src="http://via.placeholder.com/300x250" alt="" class="feat-proj__image">
               ...
               <div class="col-2-of-3">
                    ...
                    <div class="promo__text-container">
                        ...
                        <div class="promo__button-container">
                            <a href="<?php the_field('button_link'); ?>" class="btn btn--white btn--large btn--darktext"><?php the_field('button_text'); ?></a>         
                        </div>
