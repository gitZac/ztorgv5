...
function html5blank_nav()
{
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul class="main-nav__menu">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('waypoints', get_template_directory_uri() . '/js/lib/jquery.waypoints.js', array('jquery'), '1.0.0'); // waypoints
...
function accent_shortcode($atts, $content = null){
    ...
    return '<span class="u-accent">' . do_shortcode($content) . '</span>'; // do_shortcode allows for nested Shortcodes
}
